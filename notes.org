...
*** Analyzer:
    - [ ] Multi-element equalities built up from pairwise, "connected component"-esque
    - [ ] Properly extract points, etc. from polygons (maybe polygon can be generalized to a "group"
      of elements)?
    - [ ] Detect properties of square, rectangle, parallelogram, etc.
*** Random Generation
    - [ ] Randomly Generate square, rectangle, parallelogram, etc
...
*** TODO More Constructions
    - [ ] Dealing with ordering of segments (a->b vs. b->a)?
