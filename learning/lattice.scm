...
(define-record-type <lattice>
  (%make-lattice partial-order-proc root)
  lattice?
...
(define (add-to-lattice lattice new-node)
  (let ((visited '()))
    (define (visited? node)
...
(let* ((root (make-lattice-node 'root '()))
  ...
  (add-to-lattice lattice c)
  (add-to-lattice lattice h)
  (add-to-lattice lattice f)
  (add-to-lattice lattice e)
  (add-to-lattice lattice g)
  (add-to-lattice lattice a)
  (add-to-lattice lattice d)
  (add-to-lattice lattice b)
  (pprint root)
  (pprint a)
  (pprint b)
  (pprint c)
